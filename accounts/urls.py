...
urlpatterns = [
    ...
    path("api/data/addteacherWeight/", views.addTeacherWeight.as_view(),name="create_weight"),
    path("api/data/getteacherWeights/", views.getTeacherWeights.as_view(),name="create_weight"),
    path("api/data/getteacherCurrentWeight/", views.getTeacherCurrentWeight.as_view(),name="create_weight"),
